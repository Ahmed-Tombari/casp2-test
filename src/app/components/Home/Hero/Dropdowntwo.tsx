...
const Dropdown = () => {
  ...
  return (
    <div className='w-full'>
      <p className='text-lg text-brand-navy/60'>Hours you going to invest?</p>
      <Listbox value={selected} onChange={setSelected}>
        <div className='relative mt-1'>
          ...
          <Transition
            ...
            leaveTo='opacity-0'>
            <ListboxOptions className='absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white dark:bg-brand-navy-dark py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-hidden sm:text-sm'>
